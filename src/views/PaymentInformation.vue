<template>
  <div>
    ...
    <div  v-if="!isOrderSuccessfulPlaced" class="m-auto my-4 border border-2  m-auto p-4 rounded rounded-4 payment-page">
      ...
      <div class="inf-div px-3  mb-5  d-inline-block m-auto">
      ...
      <div class=" px-3 inf-div d-inline-block m-auto">
